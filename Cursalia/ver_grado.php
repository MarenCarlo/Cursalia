...
<body>
    ...
    <section id="Centro" class="SectionCen col-lg-10">
        <div class="SectionCenInt">
            <?php
                require 'vistas/data_grados_cards.php';
                ?>
        </div>
    </section>
...
<?php
        ...
        header('location: menu?alert_null_pointer=<p class="msg_error_permissions">Cursalia no recibio ningun identificador de Grado... :(</p>');
    }
} else {
