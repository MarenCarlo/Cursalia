...
<body>
    ...
    <section id="Centro" class="SectionCen col-lg-10">
        <div class="SectionCenInt">
            <div id="Form_AddP">
                <form action="controlador/archivo_contenido.php" method="POST" enctype="multipart/form-data" class="form login">
                    <center>
                        <h6>Nombre del Contenido</h6>
                    </center>
                    <div class="form__field">                               
                        ...
                        <input name="ContentTit1" id="login__username" type="text" class="form__input" placeholder="Titulo del Contenido" required/>    
                    </div>    
                    <center>
                    ...
                    <div class="form__field">
                        ...
                        <textarea name="ContentDesc1" onKeyDown="count_it()" id="text__area" maxlength="1024" class="form__input" id="login__username exampleFormControlTextarea1" rows="8" placeholder="Describe brevemente sobre que habla este contenido" required></textarea>
                        <div class="wrap2">
                    ...
                    <div class="form__field">
                        ...
                        <input id="file__input" class="form__input" type="file" name="ContentFile"style="padding-left: 20px;" required>
                    </div>
                    <center>
                        <button name="ContentCurs" value="<?php echo $curso;?>" type="submit" class="btn btn-info purple-gradient col-3-sm-12">Enviar Datos!</button> 
                    </center>
                    <br>
                </form>
            </div>
