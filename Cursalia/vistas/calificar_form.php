...
?>
    <div id="Form_AddP" class="">
        <form action="controlador/calificar.php" method="POST" class="form login" enctype="multipart/form-data">
            ...
            <section>
                ...
                <center>
                    <a href="controlador/ver_archivo.php?Nom=<?php echo $columna['13'];?>&Rut=<?php echo $columna['14'];?>" style="color: #157EFB; font-size: 12pt;">ver archivo</a>
                </center>
                <br>
                <h6>puntaje:</h6>
                <div class="form__field">                          
                    ...
                    <input id="login__username" name="calificacion1" type="number" class="form__input" placeholder="<?php echo $columna['12']; ?> / 100" required/>    
                </div>                          
            </section>                      
