<div id="Form_AddP">
    <form action="controlador/nueva_actividad.php" method="POST" class="form login" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-4">
                <center>
                ...
                <div class="form__field">
                    ...
                    <input name="ActFechaEnt1" data-provide="datepicker" id="datepicker" type="text" class="form__input" required readonly />
                </div>
            </div>
            <div class="col-lg-4">
                <center>
                    ...
                    <select name="ActTipoCal1" id="select__form" class="form__input" class="form-control" required>
                        ...
                        <?php
                            require_once "controlador/conexion.php";
                                                 ...
                                                 * debe seleccionar.
                                                 */
                            $sqlX2 = 'SELECT * FROM Tipo_Calificacion;';
            ...
            <div class="col-lg-4">
                ...
                <div class="form__field">
                    ...
                    <input name="ActTimeEnt1" type="time" class="form__input" value="show" required/>
                </div>
            </div>
        </div>
        <div class="form__field">
            ...
            <input name="ActTitle1" id="login__username" type="text" class="form__input" placeholder="Titulo de la actividad" required />
        </div>
        <section>
            <div class="form__field">
                <label for="exampleFormControlSelect1" class="blue-gradient">
        ...
        <div class="form__field">
            ...
            <textarea name="ActDescrip1" onKeyDown="count_it()" id="text__area" maxlength="1024" class="form__input" id="login__username exampleFormControlTextarea1" rows="8" placeholder="Describe brevemente sobre que trata la actividad" required></textarea>
            <div class="wrap2">
        ...
        <center>
            <div class="form__field grid2">
                <input class="purple-gradient" type="submit" value="Ingresar Actividad!">
            </div>
        </center>
        <br>
    </form>
