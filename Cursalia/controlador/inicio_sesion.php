                ...
                */
                ...
                if($result1 > 0){
                        ...
                        */
                        ...
                        if($State_Platform['0'] == "Activo" || $data['FK_Rol'] == 1){
                            ...
                            $_SESSION['Master']     = $data['Jefe_Maestro'];
                            ...
                            */
                            ...
                            mysqli_close($conexion);
                            header('location: ../../index.php?alert_InSes=<p class="msg_error">El sitio esta actualmente en Mantenimiento, intente ingresar mas tarde.</p>');
                        }
                    }else{
                        /*
