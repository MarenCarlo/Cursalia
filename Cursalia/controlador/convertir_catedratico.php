    ...
    if($_SESSION['active'] == true){
        ...
        if (isset($_GET['user'])){
            ...
            if($RowData1['0'] != 1){
                ...
                mysqli_close($conexion);
                header('Location: ../menu.php?alert_null_pointer=<p class="msg_error_permissions">No se pudo convertir en Catedratico al Usuario, por que este es el usuario Maestro... :(</p>');
            }
        } else {
            mysqli_close($conexion);
